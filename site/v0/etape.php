	...
	<body> 
		...
		<div class="w3-main" style="margin-left:340px;margin-right:40px">
			...
			<div style="text-align:center;margin-top:80px">
				...
				<center>
				<div>
					<?php if($parcours_ok) { echo '<a class="ps-lien-pop" style="width:50%" href="//site/v0/parcours.php?id_comp='.$_GET['id_comp'].'">';} 
						  else { echo '<a class="ps-lien-gray" style="width:50%" href="#">';} ?>
						<span style="font-family: Calibri;">Parcours</span>
					</a> 	
				</div>
				<div>
					<?php if($joueurs_ok) { echo '<a class="ps-lien-pop" style="width:50%" href="//site/v0/joueurs.php?id_comp='.$_GET['id_comp'].'">';} 
						  else { echo '<a class="ps-lien-gray" style="width:50%" href="#">';} ?>
						<span style="font-family: Calibri;">Joueurs</span>
					</a> 	
				</div>
				<div>
					<?php if($demarrer_ok) { echo '<a class="ps-lien-pop" style="width:50%" href="//site/v0/demarrer.php?id_comp='.$_GET['id_comp'].'">';} 
						  else { echo '<a class="ps-lien-gray" style="width:50%" href="#">';} ?>
						<span style="font-family: Calibri;">Démarrer</span>
					</a>
				</div>
				<div>
					<?php if($saisieSc_ok) { echo '<a class="ps-lien-pop" style="width:50%" href="//site/v0/saisirScores.php?id_comp='.$_GET['id_comp'].'">';} 
						  else { echo '<a class="ps-lien-gray" style="width:50%" href="#">';} ?>
						<span style="font-family: Calibri;">Saisir les scores</span>
					</a> 	
				</div>
				<div>
					<?php if($publieSc_ok) { echo '<a class="ps-lien-pop" style="width:50%" href="//site/v0/publierScores.php?id_comp='.$_GET['id_comp'].'">';} 
						  else { echo '<a class="ps-lien-gray" style="width:50%" href="#">';} ?>
				...
				<hr class="ps-color">
				<div>
					<?php echo '<a class="ps-lien-pop" style="width:50%" href="//site/v0/liveScore.php?id_comp='.$_GET['id_comp'].'">'; ?>
						<span style="font-family: Calibri;">Live Score</span>
					</a> 	
				</div>
				<hr class="ps-color">
				<div>
					<a class="ps-lien-pop" style="width:50%" href="//site/v0/index.php">
